...
X_train_datasets_13d_unsampled = []
y_train_datasets_13d_unsampled = []
X_test_datasets_13d_unsampled = []
y_test_datasets_13d_unsampled = []
            ...
            for cs in class_separation:
                for num_c in num_clusters:
                    ...
                    for train_index, test_index in sss.split(X, y):
                        ...
                        X_train_datasets_13d_unsampled.append(Xtrain)
                        y_train_datasets_13d_unsampled.append(ytrain)
                        X_test_datasets_13d_unsampled.append(Xtest)
                        y_test_datasets_13d_unsampled.append(ytest)
