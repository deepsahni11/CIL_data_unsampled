...
np.save('../datasets_15d_X_train_unsampled.npy',X_train_datasets_15d_unsampled)
np.save('../datasets_15d_X_test_unsampled.npy',X_test_datasets_15d_unsampled)
np.save('../datasets_15d_y_train_unsampled.npy',y_train_datasets_15d_unsampled)
np.save('../datasets_15d_y_test_unsampled.npy',y_test_datasets_15d_unsampled)
