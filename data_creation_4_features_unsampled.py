...
np.save('../datasets_4d_X_train_unsampled.npy',X_train_datasets_4d_unsampled)
np.save('../datasets_4d_X_test_unsampled.npy',X_test_datasets_4d_unsampled)
np.save('../datasets_4d_y_train_unsampled.npy',y_train_datasets_4d_unsampled)
np.save('../datasets_4d_y_test_unsampled.npy',y_test_datasets_4d_unsampled)
