...
X_train_datasets_8d_unsampled = []
y_train_datasets_8d_unsampled = []
X_test_datasets_8d_unsampled = []
y_test_datasets_8d_unsampled = []
            ...
            for cs in class_separation:
                for num_c in num_clusters:
                    ...
                    for train_index, test_index in sss.split(X, y):
                        ...
                        X_train_datasets_8d_unsampled.append(Xtrain)
                        y_train_datasets_8d_unsampled.append(ytrain)
                        X_test_datasets_8d_unsampled.append(Xtest)
                        y_test_datasets_8d_unsampled.append(ytest)
...
np.save('../Data_metrics_8d_datasets_X_train_unsampled.npy',X_train_datasets_8d_unsampled)
np.save('../Data_metrics_8d_datasets_X_test_unsampled.npy',X_test_datasets_8d_unsampled)
np.save('../Data_metrics_8d_datasets_y_train_unsampled.npy',y_train_datasets_8d_unsampled)
np.save('../Data_metrics_8d_datasets_y_test_unsampled.npy',y_test_datasets_8d_unsampled)
